<div>
                            ...
                            <div class="right-sec-rental">
                                ...
                                <p class="alen-park-text1 img-b-space1">
                                    <span class="p-responsive-main location-image-icon img-b-space1">
                                        ...
                                        <label>{{ $user->travelType->address }},{{ $user->travelType->zip_code }}</label>
                                    </span>
                        ...
                        <div class="container">
                            <div class="table_user_top_sec gap_cmnn">
                                <div class="row table_user_top_sec_row gy-2">
                                    ...
                                    {{-- <div class="col-lg-4 table_user_top_sec_col_rght">
                                        <div class="cmn_selct_filter">
                                            <select class="form-select" wire:model.defer = "status"
                                                aria-label="Default select example" wire:change="StatusWiseUser">
                                    ...
                                    <div class="col-lg-4 table_user_top_sec_col_rght">
                                        <div class="cmn_selct_filter">
                                            <select class="form-select" wire:model.defer = "namerole" aria-label="Default select example"  wire:change="nameRoleWiseUser">
                                                <option selected value="name(A-Z)">Names - A to Z</option>
                                    ...
                                    <div class="row table_user_bttm_sec_head_row gy-4">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="custom_checked_box">
                                                                                <input
                                                                                    class="form-check-input checkuser"
                                                                                    type="radio"
                                                                                    wire:click="selectUserId({{ $data->id }})"
                                                                                    value="{{ $data->id }}"
                                                                                    wire:model="hotel_user_id"
                                        ...
                                        <div class="col-lg-3 table_user_bttm_sec_head_col_lft">
                                            <div class="table_support_cnt_rt">
                                                <a href="javascript:void(0)" class="btn_table_s grn"
                                                    wire:click.prevent="editRentalAccessUser">Edit
                                                    User</a>
                                                <a href="javascript:void(0)" class="btn_table_s purpl"
                                                    wire:click.prevent="editRentalAccessRoleUser">Change Role</a>
                                                <a href="javascript:void(0)" class="btn_table_s ylw"
                                                    wire:click.prevent="changePassword">Change PW</a>
                                                @if ($status != -1)
                                                @if ($status == 1)
                                            ...
                                            @else
                                                ...
                                                @endif
                                            @endif
                                            <a href="javascript:void(0)" class="btn_table_s blu" wire:click="pendingUser">Pending
                                                User Invites</a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <form wire:submit.prevent='addNewUser'>
                    ...
                    <div class="modal-footer">
                        <div class="btn_foot_end">
                            {{-- <a href="javascript:void(0)" class="btn_table_s grn" wire:click="pendingUser">Pending
                                User Invites</a> --}}
    ...
    <!-- Add_role_modal -->
    <div wire:ignore.self class="modal fade cmn_modal_designs modal_role_wrap_dialog" id="add_role_modal"
                    ...
                    <div class="assign_role_userpt">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Smart rental access management</td>
                                    <td class="multiple_inner_tabl">
    ...
    {{-- pending User Model --}}
    <div wire:ignore.self class="modal fade cmn_modal_designs" id="pendingUserModal" aria-hidden="true"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border: 2px #000 solid;">
                <div class="modal-header">
                    <h5 class="modal-title">Pending User Invites</h5>
                    <button type="button" class="btn-close close_hotel_pending_model" data-bs-dismiss="modal"
                                            ...
                                            <td>
                                                <div class="selctd_table_sec">
                                                    <select class = "pendingOption">
                                                        ...
                                                        <option style="text-align:center;" class="remove"
                                                            value="{{ $puser->id }}">Remove</option>
                                                        <option style="text-align:center;" class="resend"
                                                            value="{{ $puser->id }}">Resend</option>
                                                        <option style="text-align:center;" class="editrequest"
                                                            value="{{ $puser->id }}">Edit request</option>
                                                    </select>
                                                </div>
                                            </td>
                                        </tr>
                ...
                <div class="modal-footer">
                    <div class="btn_foot_end">
                        <a href="javascript:void(0)" class="btn_table_s rdd close_hotel_pending_model" 
    ...
    {{-- remove pending user --}}
    <div wire:ignore.self class="modal fade cmn_modal_designs gap_sec_modal2" id="remove_pending_modal"
        tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border: 2px #000 solid;">
                <div class="modal-body">
    ...
    <div wire:ignore.self class="modal fade cmn_modal_designs gap_sec_modal2" id="deactivateuser_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="wrap_modal_cntntr">
                        ...
                        <div class="cmn_secthd_modals_btnnn">
                            <div class="btn_foot_end centr">
                                <button class="btn_table_s blu auto_wd" wire:click="deactivateUserStatus()">Yes</button>
                        ...
                        <div class="cmn_secthd_modals_btnnn">
                            <div class="btn_foot_end centr">
                                <button class="btn_table_s blu auto_wd"
                                    wire:click.prevent="hideSuccessModal">ok</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @push('scripts')
        <script>
            ...
            $(document).on('click','.close_hotel_pending_model',function(){
                location.reload();
            });
            ...
            document.addEventListener('livewire:load', function(event) {
                ...
                @this.on('showRemoveModal', data => {
                    $('#deactivateuser_modal').modal('show');
                    $("#user_name").html(data.name);
                });
                @this.on('hideDeactivateModal', function () {
                    $('#deactivateuser_modal').modal('hide');
                    })
