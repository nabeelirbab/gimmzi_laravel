...
class CreateReport extends Component
{
    ...
    public function mount(){
        $this->types = ReportType::where('status',1)->where('portal','short-term')->get();
    ...
    public function updatedReportType(){
        ...
        $this->report = GeneratedReport::where('type_id',$this->report_type)
                        ...
                        ->where('travel_tourism_id',auth()->user()->travel_tourism_id)
                        ->first();
        if($this->report){
    ...
    public function createReport(){
        ...
        if($this->report){
            ...
            $this->report->travel_tourism_id = auth()->user()->travel_tourism_id;
            $this->report->save();
    ...
    {
        $this->emit('enabledatepicker');
        return view('livewire.frontend.travel-tourism.short-term-rental.create-report');
    }
}
