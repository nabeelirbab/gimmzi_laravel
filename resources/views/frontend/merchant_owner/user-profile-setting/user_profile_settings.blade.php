<x-layouts.frontend-layout title="Business Owners User Profile Setting Page">
                          ...
                          <div class="mcd_form_inner">
                            ...
                            <div class="row mcd_form_row">
                              ...
                              <div class="col-lg-12 mcd_form_col" style="border: 1px #000 solid;background-color: #e6e6e6;">
                                <h3>Email and Text Preferences</h3>
                                <p>You may receive additional notifications about provider updates on Gimmzi. You can opt-out of specific emails and or texts using the unsubscribe link included in each message.</p>
                              </div>
                              <div class="col-lg-6 mcd_form_col">
                                
                                <p><span class="cst_chk">
                              ...
                              <div class="col-lg-6 mcd_form_col">
                                ...
                                <span class="cst_chk">
                                  ...
                                  <label for="dateCheck" style="margin-left: 7px;color:black;">Unsubscribe from All notifications</label></p>  
                                </span>
                              </p>
                                  </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-m-4">
                                <div class="uploard-logo-one">
                                    ...
                                    <img id="preview_photo" style="width: 230px;height: 147px;border-radius: 7%;" src="{{$user->profile_image}}"/>
                                    @else
    ...
    $(document).ready(function () {
        ...
        $("#edit_my_profile").submit(function(e) {
          ...
          $.ajaxSetup({
            ...
            $.ajax({
                    url: "{{ route('frontend.business_owner.update_user_profile') }}",
                    type: 'POST',
