<x-admin-layout title="Property Management">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        {{ Form::open(['route' => ['hotel-buildings.store'], 'class' => 'kt-form parsley-validate', 'method' => 'POST','files'=>true]) }}
        <div class="kt-portlet__body">
        <div class="row" style="align-self: flex-end;margin-bottom: 11px;">
            <a href="{{asset('uploads/hotel_building_data.csv')}}" target="_blank" class="btn btn-success">Sample csv</a>
        </div>
            <div class="row">
            ...
            <div class="kt-portlet__foot">
                <div class="kt-form__actions" id="submitbutton">
                    ...
                    <a href="{{ route('hotel-buildings.index') }}" class="btn btn-secondary">Cancel</a>
                </div>
            </div>
            {{ Form::close() }}
            <!--end::Form-->
