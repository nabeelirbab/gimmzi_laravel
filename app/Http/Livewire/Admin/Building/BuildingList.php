...
class BuildingList extends Component
{
    ...
    {
        $buildingQuery = ProviderBuilding::query();
        if ($this->searchName)
        ...
        return view('livewire.admin.building.building-list', [
    ...
    public function changeStatus(ProviderBuilding $provider_building)
    {
       
        $provider_building->fill(['status' => ($provider_building->status == 1) ? 0 : 1])->save();
