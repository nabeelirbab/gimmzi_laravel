        ...
        <tbody>
            <tr>
                <td style="padding-top: 50px;" colspan="2"><a href="javascript:void(0)"
                        style="display: block;margin: 0 auto 10px;width: 150px;"><img
                            src="{{ $mail_data['short_term_logo'] }}" alt="" style="width: 100%;"></a></td>
            </tr>
            <tr>
                <td colspan="2">
                    <p
            ...
            <tr>
                <td style="padding-bottom: 30px;" colspan="2">
                    <p style="margin: 0;text-align: center;font-size: 18px;font-weight: 400;">-{{ $mail_data['name'] }}
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td style="box-sizing: border-box; padding: 0 0 30px 20px; width: 48%;">
                    <h1
                        ...
                        {{ $mail_data['listing_name'] }} </h1>
                    <p
                        style="margin: 0 0 15px;padding-bottom: 10px;border-bottom: 1px solid #ededed;font-size: 18px;color: #010101;font-weight: 500;">
                        {{ $mail_data['bedroom'] }} Bedrooms | {{ $mail_data['bathroom'] }} Baths |
                        {{ $mail_data['guests'] }} Guests </p>
                    ...
                    <a href="{{ route('frontend.short-term-website-checking', $mail_data['encrypt_id']) }}"
