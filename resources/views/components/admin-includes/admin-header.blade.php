        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    @php 
                      $words = explode(" ", Auth::user()->full_name);
                        $name = "";
                    ...
                    @endphp
                    <span class="@if(Auth::user()->profile_photo_url)kt-hidden @endif kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold">{{$name}}</span>
                </div>
            </div>
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                ...
                <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url({{asset('admin_assets/media/misc/bg-1.jpg')}})">
                    <div class="kt-user-card__avatar">
                        ...
                        <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                        <span class="@if(Auth::user()->profile_photo_url)kt-hidden @endif kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success ">{{$name}}</span>
                    </div>
