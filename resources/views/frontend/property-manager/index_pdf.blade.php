...
<body style="margin: 0; padding: 0;">
  ...
  <tr>
    <td width="100%" style=" padding: 20px 15px 20px; text-align: center;">
        <h2 style="margin: 0 0 5px; font-size: 24px; color: #26a7df; line-height: 1;">Welcome to {{$unit_name}}</h2>
        <h3 style="margin: 0 0 10px; font-size: 18px; font-weight: bold;">We're excited to have you as our guest at {{$unit_name}}! </h3>
