                ...
                <div class="row">
                                ...
                                @if($users)
                                    @foreach($users as $user) 
                                        {{-- @dd($user) --}}
                                            ...
                                            <td><?php 
                                                $checkoutDate = date('m-d-Y',strtotime($user['account_term_date']));
                                                // echo $checkoutDate;
                                            ?>
                                                {{ $checkoutDate}}
                                            </td>
                    ...
                    <div class="col-md-3">
                        <div class="btn_area_section">
                            ...
                            <a href="{{route('frontend.hotel_resort.smart-rental-db')}}"  class="btn purple_btn">Go to Guest Database</a>
