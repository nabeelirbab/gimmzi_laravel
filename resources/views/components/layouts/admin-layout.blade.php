...
<head>
    <meta charset="utf-8" />
    <title>{{ config('app.name', 'Gimmzi') }} | {{$title}}</title>
    ...
    <link href="{{asset('admin_assets/vendors/general/bootstrap-select/dist/css/bootstrap-select.css')}}" rel="stylesheet" type="text/css" />
    ...
    <!--end::Layout Skins -->
    <link rel="shortcut icon" href="{{asset('admin_assets/media/logos/gimmzi-icon.png')}}" />
...
<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
    ...
    <script src="{{asset('admin_assets/vendors/general/select2/dist/js/select2.full.js')}}" type="text/javascript"></script>
    <script src="{{asset('admin_assets/app/custom/general/crud/forms/widgets/select2.js')}}" type="text/javascript"></script>
    <script src="{{asset('admin_assets/vendors/general/bootstrap-select/dist/js/bootstrap-select.js')}}" type="text/javascript"></script>
    <script src="{{asset('admin_assets/app/custom/general/crud/forms/widgets/bootstrap-select.js')}}" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    {{-- <script src="http://maps.google.com/maps/api/js?key=AIzaSyCA1NDFrM3NlLYrt4Pk8_jYR5Zvja-giC0"></script> --}}
    <script>
