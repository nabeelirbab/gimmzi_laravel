<div>
        ...
        <div class="container">
            <div class="hotel-portal-wrapper">
                <div class="row align-items-center">
                    <div class="col-lg-9">
                        <div class="hotel-portal-left-panel extra_hotel_portal">
                            <div class="hotel-portal-logo">
                                <img src="{{ $travel_tourism->short_term_logo }}" style="border-radius: 5px;"
                                    alt="title">

                                <a href="{{ route('frontend.other-short-term-listing', base64_encode($travel_tourism->id)) }}"
                                    class="wrap-link">view more listing</a>
                            </div>
                            <div class="hotel-portal-info">
                                <div class="main-cate">{{ $travel_tourism->name }} - {{ $short_rental->city ?? ' ' }}
                                    {{ $short_rental->city ? ',' : '' }} {{ $short_rental->states->name }}</div>
                                <h1>{{ $short_rental->name }}</h1>

                                <p>{{ $short_rental->description }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                ...
                <ul class="del-info">
                    <li>
                        {{-- <img src="{{ asset('frontend_assets/images/location-pin.svg')}}" class="del-info-icon" alt=""> --}}
                        {{ $short_rental->city }} , {{ $short_rental->states->name }}
                    </li>
                    <li>
                        <img src="{{ asset('frontend_assets/images/Bullet.png') }}" class="del-info-icon"
                            alt="">
                        {{ $short_rental->type->name }}
                    </li>
                    <li>
                        <img src="{{ asset('frontend_assets/images/Bullet.png') }}" class="del-info-icon"
                            alt="">
                        {{ $short_rental->no_of_bedrooms }} Bedrooms
                    </li>
                    <li>
                        <img src="{{ asset('frontend_assets/images/Bullet.png') }}" class="del-info-icon"
                            alt="">
                        {{ $short_rental->no_of_baths }} Baths
                    </li>
                    <li>
                        <img src="{{ asset('frontend_assets/images/Bullet.png') }}" class="del-info-icon"
                            alt="">
                        {{ $short_rental->no_of_guests }} Guests
                    </li>
                    {{-- @if($badge_bonus_point)
                        <li style="color: #24739a; font-size:18px; margin-left:2rem;">Rewards Badges starting at <span
                                style="color:#4f7f18; margin-left:6px;">{{ $badge_bonus_point }} points per day</span></li>
                    @endif --}}
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <ul class="hotel-portal-navigate-nav">
                ...
                @if ($external_manage)
                    ...
                    @endif
                    @if ($external_manage->guest_portal_display == 1)
                        <li class="nav-item @if ($guestPortalTab == true) active @endif">
                            <a href="javascript:void(0);" wire:click="showGuestPortal">Guest Portal</a>
                        </li>
                    @endif
            ...
            <div class="navigate-panel">
                                                ...
                                                <div class="small_media_list_slider">
                                                    <div class="small-media-divide-col">
                                                        <div class="small-media-box">
                                                            <a href="{{ $short_rental->main_img }}"
                                                                data-fancybox="gallery">
                                                                <img src="{{ $short_rental->main_img }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <ul class="media-list">
                                                        <li>
                                                            <a href="Javascript:void(0);" wire:click="sharePage"
                                                                class="cmn-share-btn" data-bs-toggle="modal"
                                                        ...
                                                        <li>
                                                            <label class="media-save-lbl">
                                                                <input type="checkbox" <?php if ($short_rental->favourite_travel == 1) {
                                                                    echo 'checked';
                                                                } else {
                                                                    echo 'disabled';
                                                                } ?>>
                                                                <span wire:click='saveList({{ $short_rental->id }})'>
                                            ...
                                            <div class="col-md-8">
                                                <div class="small-media">
                                                    <div class="small_media_list">
                                                        @if (count($short_rental->photo_img) > 0)
                                                            @foreach ($short_rental->photo_img as $photo)
                        ...
                        <form wire:submit.prevent="sendRequestForListing">
                            <div class="row request-info-row">
                                ...
                                <div class="col-md-6 request-col" wire:ignore>
                                    <label>Listing</label>
                                    <input type="text" value="{{ $short_rental->name }}" readonly>
                                </div>
                                {{-- <div class="col-md-6 request-col" >
                                    <label>Listings</label>
                                    <div class="multiSelect_wrap" wire:ignore>
                                        <select class="multiSelect2" wire:model.defer="listing_id" data-placeholder="Choose anything" multiple>
                                            @if (count($travel_tourism->listing) > 0)
                                                @foreach ($travel_tourism->listing as $listings)
                ...
                @endif
                @if ($guestPortalTab == true)
                    <div class="row">
                        <div class="col-lg-12" style="margin-bottom: 170px;">
                            <div class="navigate-panel-left">
                                @if ($external_manage->guest_portal_url != '')
                                    <p class="websitebutton"><strong> </strong><a
                                            href="{{ $external_manage->guest_portal_url }}" target="_blank">Guest
                                            Portal</a></p>
                                @else
                                    <p><strong>Coming Soon</strong></p>
                                @endif
                ...
                @if ($locationTab == true)
                    <div class="location-map">
                        <span class="location-title">{{ $short_rental->street_address }}</span>
                ...
                <div class="modal-body">
                    <div class="share-property">
                        <div class="share-property-image">
                            <img src="{{ $short_rental->main_image }}" alt="">
                        </div>
                        <div class="share-property-intro">
                            <h3 class="share-property-title">{{ $this->short_rental->name }}</h3>
                            <p class="share-property-location">{{ $short_rental->city ?? '' }}
                                {{ $short_rental->city ? ',' : '' }} {{ $short_rental->states->name }}</p>
                            <ul class="share-property-facility">
                                <li>{{ $short_rental->type->name }}</li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="share-property-option-box">
                                    <input type="hidden"
                                        value="{{ url('/short-term-rental-website/' . $encrypt_id) }}"
                                        id="myInput">
                    ...
                    <div class="wrap_modal_cntntr">
                        ...
                        <div class="cmn_secthd_modals_btnnn">
                            <div class="row checkbox_bottom_btn">
                                ...
                                <div class="col-md-6">
                                    <div class="btn_foot_end centr">
                                        <button class="btn_table_s grn auto_wd"
                                            wire:click="loginForFavorite">Login</button>
                                    </div>
                                </div>
    ...
    <div class="modal fade new_registration_badge_modal" data-bs-backdrop = 'static' keyboard = "false" id="registration_form_modal" tabindex="-1"
    ...
    <div class="modal fade cmn_modal_designs gap_sec_modal2" id="badge_success_modal" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border: 2px solid #000;border-radius: 10px;">
                <div class="modal-body">
        ...
        <script>
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            if (result.success == true) {
                                ...
                                else if (result.text == 'user_under_badge') {
                                    $(".registerForm").css('display', 'none');
                                    $(".submitForm").css('display', 'none');
                                    $(".email_error").text('This consumer is already have an active badge.');
                                    setTimeout(function() {
                                           location.reload();
                                    }, 1200);
                                } else {
                                    ...
                                    if($(".zip_code").val() != ''){
                                        $.ajax({
                                            ...
                                            data: {
                                                ...
                                                consumer_birth_month: $('.consumer_birth_month').val(),
                                                consumer_birth_day: $('.consumer_birth_day').val(),
                                                consumer_birth_year: $('.consumer_birth_year').val(),
                                        ...
                                        $('.zip_error').text('Give your Zip Code');
                                    }
            ...
            $("#guest_password_submit").submit(function(e) {
                ...
                if($("#consumer_password").val() != ''){
                    ...
                    $.ajax({
                        url: "{{ route('travel.guest_password_submit') }}",
                        type: 'POST',
                        data: {
            ...
            document.addEventListener('livewire:load', function(event) {
                ...
                @this.on('openLocation', function() {
                    setTimeout(function() {
                        var propertylat = '<?php echo $short_rental->lat; ?>';
                        var propertylong = '<?php echo $short_rental->long; ?>';
                        var mapOptions2 = {
                            zoom: 10
                        };
                ...
                @this.on('shareListingDetail', function() {
                    ...
                    var id = "{{ $encrypt_id }}";
                    var url = "<?php echo url('/short-term-rental-website/"+id+"'); ?>";
