    ...
    <x-slot name="tbody">
        @forelse($units as $data)
            <tr role="row" class="odd">
                ...
                <td class="sorting_1 align-center" tabindex="0">{{ $data->unitbuildings->building_name }}</td>               
                {{-- <td class="align-center">{{ $data->user->full_name }}</td> --}}
                <td class="align-center">{{ $data->unit_name }}</td>
                ...
                <x-admin.td-action>
                    <a class="dropdown-item" href="{{ route('hotel-unit.edit', ['hotel_unit' => $data->id]) }}"><i class="la la-edit"></i> Edit</a>
