                    ...
                    <div class="allen-part-tab-one-main">
                        <nav>
                            <div class="nav nav-tabs mb-3 nav-cutom-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-orderonline-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-orderonline" type="button" role="tab"
                                    aria-controls="nav-orderonline" aria-selected="true">Order
                                    Online</button>
                                <button class="nav-link" id="nav-menu-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-menu" type="button" role="tab" aria-controls="nav-menu"
                                    aria-selected="true">View Menu</button>
                                <button class="nav-link" id="nav-career-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-career" type="button" role="tab"
                                    aria-controls="nav-career" aria-selected="true">Careers</button>
                                <button class="nav-link" id="nav-eventFlyer-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-eventFlyer" type="button" role="tab"
                                    aria-controls="nav-eventFlyer" aria-selected="true">View Event Flyer</button>
                                <button class="nav-link" id="nav-website-tab1" data-bs-toggle="tab"
                                    data-bs-target="#nav-website" type="button" role="tab"
                                    aria-controls="nav-website" aria-selected="false">Visit Direct Website</button>
                        ...
                        <div class="tab-content allen-container-mid" id="nav-tabContent">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="row allen-container-mid-one">
                                                <div class="col-sm-5">
                                                    @if ($business_profile != '')
                                                        <img src="{{ url($business_profile->main_image) }}"
                            ...
                            <div class="tab-pane fade" id="nav-orderonline" role="tabpanel"
                                aria-labelledby="nav-orderonline-tab1">
                                <div class="allen-container-mid">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="row allen-container-mid-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    @else
                                                        <?php $order_online = ''; ?>
                                                    @endif
                                                    <p class="websitebutton" id="orderOnlineLink"><strong>Click On:
                                                        </strong><a href="{{ $order_online ? $order_online : '' }}"
                                                        ...
                                                        <div class="col-lg-4 col-md-6 vw_item">
                                                            <div class="vw_item_img">
                                                                <a href="{{ $image1 }}" data-lightbox="lgt1">
                                                                    <img id="menu1image" src="{{ $image1 }}"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="vw_item_text">
                                                                <a href="{{ $image1 }}"
                                                                    data-lightbox="lgt1">View</a>
                                                                <a href="#">Download</a>
                                                            </div>
                                                        </div>
                            ...
                            <div class="tab-pane fade" id="nav-career" role="tabpanel"
                                aria-labelledby="nav-career-tab1">
                                <div class="allen-container-mid">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="row allen-container-mid-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    @else
                                                        <?php $career = ''; ?>
                                                    @endif
                                                    <p class="websitebutton" id="careerLink"><strong>Click On:
                                                        </strong><a href="{{ $external_manage->carrer_url ?? '#' }}"
                                                            target="_blank">Careers</a></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                            ...
                            <div class="tab-pane fade" id="nav-eventFlyer" role="tabpanel"
                                aria-labelledby="nav-eventFlyer-tab">
                                <div class="allen-container-mid">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="row allen-container-mid-one">
                                                        ...
                                                        <div class="col-lg-6 col-md-12 vw_item">
                                                            <div class="vw_item_img">
                                                                <a href="{{ $flyer1image }}" data-lightbox="lgt1">
                                                                    <img id="flyer1image" src="{{ $flyer1image }}"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="vw_item_text">
                                                        ...
                                                        <div class="col-lg-6 col-md-12  vw_item">
                                                            <div class="vw_item_img">
                                                                <a href="{{ $flyer2image }}" data-lightbox="lgt1">
                                                                    <img id="flyer2image" src="{{ $flyer2image }}"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="vw_item_text">
                            ...
                            <div class="tab-pane fade" id="nav-website" role="tabpanel"
                                aria-labelledby="nav-website-tab1">
                                <div class="allen-container-mid">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="row allen-container-mid-one">
                                                    ...
                                                    @if ($external_manage)
                                                        @if ($external_manage->direct_website_display != 0)
                                                            @if ($external_manage->direct_website_url != '')
                                                                <p class="websitebutton" id="directLink"><strong>Click
                                                                        On: </strong><a
                                                                        href="{{ $external_manage->direct_website_url }}"
                                                                        target="_blank">{{ $external_manage->direct_website_url }}</a>
                                                                </p>
                                                            @else
