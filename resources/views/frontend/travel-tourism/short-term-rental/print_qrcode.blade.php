...
<body style="margin: 0; padding: 0;">
  ...
  <tr>
    <td width="100%" style=" padding: 20px 15px 20px; text-align: center;">
        <h2 style="margin: 0 0 5px; font-size: 24px; color: #26a7df; line-height: 1;">Welcome to {{$data['city']}}, {{$data['state']}}</h2>
        <h3 style="margin: 0 0 10px; font-size: 18px; font-weight: bold;">We're excited to have you as our guest at {{$data['provider_name']}}! </h3>
            ...
            <tr>
                ...
                <td style="vertical-align: middle; width: 25%;">
                    <div style="max-width: 220px; width: 100%; margin-left: auto;">
                        <img style="width: 100%;" src="https://gimmzi-smart.dedicateddevelopers.us/frontend_assets/images/gimmzilogo.jpg" alt="">
                    </div>
                </td>
                <td style="vertical-align: middle; width: 25%; padding-left: 10px;">
                    <div style="display: block; border-radius: 10px; width: 100%; max-width: 150px; overflow: hidden;">
                            <img style="width: 100%;" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(256)->generate($data['text'])) !!} ">
                    </div>
                </td>
                <td style="vertical-align: middle; width: 25%;"></td>
            </tr>
