...
<x-admin.table>
    ...
    <x-slot name="tbody">
        ...
        <tr role="row" class="odd">
            ...
            <td class="align-center">{{ $hotel->address }}</td>
            <td class="align-center"><span
                    class="kt-badge  kt-badge--{{ $hotel->status == 1 ? 'success' : 'warning' }} kt-badge--inline kt-badge--pill cursor-pointer"
                    wire:click="changeStatusConfirm({{ $hotel->id }})">{{ $hotel->status == 1 ? 'Active' :
                    'Inactive' }}</span>
            </td>
            <x-admin.td-action>
                <a class="dropdown-item" href="{{ route('hotel-resorts.edit', $hotel->id) }}"><i
