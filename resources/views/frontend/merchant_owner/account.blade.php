<x-layouts.frontend-layout title="Business Owners Account Page">
                                ...
                                @if (Auth::user()->user_title == 'Associate')
                                    ...
                                    <ul class="p-0 border-0">
                                        ...
                                        <li>
                                            <a href="{{ route('frontend.business_owner.item_service_list') }}">
                                                <img height="44"
                                                    src="{{ asset('frontend_assets/images/icon9.svg') }}"
                                                    class="cat-left-icon img-one407" />
                                                Item and Service Database</a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="p-0 border-0">
                                        ...
                                        <li>
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#participatingLocation"> <img
                                        ...
                                        <li>
                                            <a href="{{ route('frontend.business_owner.merchant_message_board') }}">
                                                <img src="{{ asset('frontend_assets/images/icon10.svg') }}"
                                                    class="cat-left-icon" />
                                                Message Boards</a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="{{ route('frontend.business_owner.business_report') }}"> <img
                                                    style="height: 44px; width: 33px;"
    ...
    <div class="modal fade" id="dealManagement" tabindex="-1" aria-labelledby="dealManagementLabel"
        aria-hidden="true">
                            ...
                            <tbody class="merchantItemList">
                                @forelse ($dealManage as $data)
                                    <tr>
                                        ...
                                        @endif
                                        <td> <a href="#" style="color: #1f8ac9;" data-id="{{ $data->id }}"
                                                class="preview_deal">Preview deal</a></td>
                                        ...
                                        @php $startdate = date_format(date_create($data->start_Date), 'm-d-Y'); @endphp
                                        <td>{{ $startdate }}</td>
                                        @if ($data->end_Date != '')
                                        ...
                                        <td>
                                            ...
                                            @if ($data->end_Date == null)
                                                <button class="end-program-btn-sec end_deal" type="button"
                                                    data-id="{{ $data->id }}"
                                                    style="margin-bottom: 10px; width:100%;letter-spacing: 0.0em;font-size: 18px;">
                                                    End Deal
                                                </button>
                                            @elseif($days > 14)
                                                <button class="end-program-btn-sec end_deal"
                                                    data-id="{{ $data->id }}" style="margin-bottom: 10px;">End
                                                    Deal
                                                </button>
                                                <button class="extend-program-btn-sec extend_deal"
                                                    data-id="{{ $data->id }}">Extend Deal
                                                </button>
                                            @elseif($days < 14)
                                                <button class="extend-program-btn-sec schedule_to_end"
                                                    data-id="{{ $data->id }}"
                                                    style="margin-bottom: 10px; background-color: #d70303;
                                                    border-color: #d70303;">Scheduled
                                                    To End
                                                </button>
                                                <button class="extend-program-btn-sec extend_deal"
                                                    data-id="{{ $data->id }}">Extend Deal
                                                ...
                                                <div class="" id="preview-deal-text">
                                                    ...
                                                    @if (count($dealManage) > 0)
                                                        <a href="javascript:void(0);"
                                                            data-id="{{ $dealManage[0]->id }}"
                                                            class="p-deal-one preview_deal_participating">Preview
                                                            Deal</a>
                                                    @endif
                                                </div>
                                            </th>
                                                        ...
                                                        @if (count($locations) > 0)
                                                            @if (count($dealManage[0]->dealLocation) == count($locations))
                                                                <input type="checkbox"
                                                                    ...
                                                                    data-id = "{{ $dealManage[0]->id }}" checked />
                                                            @else
                                                                <input type="checkbox"
                                                                    class="assign-one1 all_deal_location_assigned"
                                                                    data-id = "{{ $dealManage[0]->id }}" />
                                                    ...
                                                    @foreach ($locations as $businesslocation)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="text-center assign-one4">
                                                                    <input type="checkbox"
                                                                        class="assign-one1 locationAssigned"
                                                                        data-id="{{ $businesslocation->id }}"
                                                                        <?php echo $checked; ?> />
                                                                </div>
                                                            ...
                                                            <td class="dealvoucher">
                                                                <div class="text-center assign-one4 assignedVoucher <?php if ($checked == 'checked') {
                                                                    echo 'checked_location';
                                                                } else {
                                                                    echo '';
                                                                } ?>"
                                                                    data-id="{{ $businesslocation->id }}">
                                            ...
                                            @else
                                                ...
                                                @if (count($locations) < 3)
                                                    <tr>
                                                        <td>
                                                            <br>
                                                            <a lass="add-participating-location"
                                                                id="add_location_modal"
                                                                style="color:#1f8ac9; cursor:pointer;">Add Service
                                                                Location</a>
                                                            <br><br>
                                                        </td>
                                                        <td></td>
                                                    ...
                                                    @if (count($loyaltyManage) > 0)
                                                        @if (count($locations) > 0)
                                                            @if (count($loyaltyManage[0]->loyaltylocations) == count($locations))
                                                                <input type="checkbox"
                                                                    class="assign-one1 all_reward_location_assigned"
                                                                    data-id = "{{ $loyaltyManage[0]->id }}"
                                                                    checked />
                                                            @else
                                                                <input type="checkbox"
                                                                    class="assign-one1 all_reward_location_assigned"
                                                ...
                                                @foreach ($locations as $businesslocation)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="text-center assign-one4">
                                                                <input type="checkbox"
                                                                    class="assign-one1 rewardlocationAssigned"
                                                                    data-id="{{ $businesslocation->id }}"
                                                                    <?php echo $checked; ?> />
                                                            </div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="active_date_prt_top_li">
                                                    ...
                                                    ?>
                                                    <p id="reward_datespan">{{ $rewardstart }} -
                                                        {{ $rewardend }}</p>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="purchase_rcv_ordr_box_row row gy-4">
                                            @if (count($loyaltyManage) > 0)
                                                <div class="col-lg-12 purchase_rcv_ordr_box_col">
                                                    <textarea class="program_description" placeholder="Purchase $150 or more and receive $5 off next order" readonly>{{ $loyaltyManage[0]->program_name }}</textarea>
                                                </div>
                                            @else
                                                <div class="col-lg-12 purchase_rcv_ordr_box_col">
                                                    <textarea class="program_description" placeholder="Purchase $150 or more and receive $5 off next order" readonly></textarea>
                                                </div>
                                            @endif
                                            <div class="col-lg-12 purchase_rcv_ordr_box_col">
                                                <button type="button"
                                                    class="btn_table_s blu go_to_manage_program">Loyalty Rewards
                                                    Management</button>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="active_date_prt_top_li">
                                                    ...
                                                    <div class="text-center assign-one4">
                                                        @if (count($dealManage) > 0)
                                                            @if ($dealManage[0]->is_split != 0)
                                                                <input type="checkbox"
                                                                    class="assign-one1 split_voucher" checked>
                                                            @else
                                                                <input type="checkbox"
                                                                    class="assign-one1 split_voucher">
                                                            @endif
                                                        @else
                                    ...
                                    <div class="purchase_rcv_ordr_box">
                                        ...
                                        <div class="purchase_rcv_ordr_box_row row gy-4">
                                            <div class="col-lg-6 purchase_rcv_ordr_box_col">
                                                ...
                                                @if (count($dealManage) > 0)
                                                    <input type="text"
                                                        placeholder="${{ $dealManage[0]->sales_amount }}"
                                            ...
                                            <div class="col-lg-6 purchase_rcv_ordr_box_col">
                                                ...
                                                @if (count($dealManage) > 0)
                                                    @if ($dealManage[0]->discount_type == 'free')
                                                        <input type="text"
                                                            placeholder="${{ $dealManage[0]->discount_amount }}"
                                                    ...
                                                    @endif
                                                @else
                                                    <input type="text" placeholder="" id="discount_price"
                                                        readonly>
                                                @endif
                                            </div>
                                            <div class="col-lg-12 purchase_rcv_ordr_box_col">
                                                @if (count($dealManage) > 0)
                                                    <textarea placeholder="{{ $dealManage[0]->suggested_description }}" id="description" readonly></textarea>
                                                @else
                                            ...
                                            <div class="col-lg-12 purchase_rcv_ordr_box_col">
                                                <button type="button"
                                                    class="btn_table_s blu go_to_deal_management">Deal
                                                    Management</button>
                                            </div>
                                        </div>
                                    </div>
                ...
                @if ($is_mobile_business == 1)
                    @if (count($active_event) == 0)
                        <form id="eventForm">
                            <div class ="container">
                                <div class ="row"
                                    style="padding-left: 35px;padding-right: 35px;padding-bottom: 90px;">
                                    <div class="col-lg-12">
                                        <div
                                            class="form-group position-relative  gimmzi-will-use d-flex select-catagory1-main">
                                            <input type="checkbox" id="advertise_event"
                                                class="gimigi-checkbok ifcheck" name="advertise_event"
                                                style="top: 28px; height: 19px;">
                                            <h3>Advertise Event</h3>
                                        </div>
                                        <p style="padding-top: 6px; color:#5a5757">
                                            Check the "Advertise Event" box to promote an event where your business will
                                            be a vendor. During the event, the event information will replace your
                                            Serving Locations on the app. If 1 Day Event is checked. only the start date
                                            will be displayed on the app. After the event ends, your Serving Locations
                                    ...
                                    <div class="col-md-12 field_col_d">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="start_event_datepicker"
                                                    placeholder="mm/dd/yyyy" name="event_start_date"
                                                    onfocus="disableAutocomplete(this)">
                                                <span>
                                                    @if ($errors->has('event_start_date'))
                                                        <div class="error" style="color:red;">
                                                            {{ $errors->first('event_start_date') }}</div>
                                                    @endif
                                                </span>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Event End Date</label>
                                                <input type="text" class="end_event_datepicker"
                                                    id= "end_event_datepicker" placeholder="mm/dd/yyyy"
                                                    name="event_end_date" onfocus="disableAutocomplete(this)">
                                                <span>
                                                    @if ($errors->has('event_end_date'))
                                                        <div class="error" style="color:red;">
                                                            {{ $errors->first('event_end_date') }}</div>
                                                    @endif
                                                </span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div
                                                class="form-group position-relative  gimmzi-will-use d-flex select-catagory1-main">
                                                <input type="checkbox" id="one_day_event"
                                                    class="gimigi-checkbok ifcheck" name="one_day_event"
                                                    style="top:24px; height: 15px;">
                                    ...
                                    <div class="col-md-12 field_col_d">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" placeholder="Street" name="event_address"
                                                    id="event_address" autocomplete="new-address"
                                                    onfocus="disableAutocomplete(this)">
                                                <span>
                                                    @if ($errors->has('event_address'))
                                                        <div class="error" style="color:red;">
                                                            {{ $errors->first('event_address') }}</div>
                                                    @endif
                                                </span>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="select-business-category" name="event_state"
                                                    id="event_state">
                                    ...
                                    <div class="col-lg-12">
                                        <button type="submit" class="add-participating-location" id="submitEvent"
                        ...
                        <div class ="container">
                            <div class ="row" style="padding-left: 35px;padding-right: 35px;padding-bottom: 90px;">
                                <div class="col-lg-12">
                                    <div
                                        class="form-group position-relative  gimmzi-will-use d-flex select-catagory1-main">
                                        <input type="checkbox" class="gimigi-checkbok ifcheck"
                                            style="top: 28px; height: 19px;pointer-events: none;" value="1"
                                            {{ isset($event) && $event->is_event_advertise == 1 ? 'checked' : '' }}>
                                        <h3>Advertise Event</h3>
                                    </div>
                                    <p style="padding-top: 6px; color:#5a5757">
                                        Check the "Advertise Event" box to promote an event where your business will be
                                        a vendor. During the event, the event information will replace your Serving
                                        Locations on the app. If 1 Day Event is checked. only the start date will be
                                        displayed on the app. After the event ends, your Serving Locations will be
                                        displayed again.
                                    </p>
                                </div>
                                <p>
                                ...
                                <div class="col-md-12 field_col_d">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label>Event Start Date</label>
                                            <input type="text"
                                                value="{{ isset($event) ? \Carbon\Carbon::parse($event->event_start_date)->format('m/d/Y') : '' }}"
                                                disabled>
                                        ...
                                        <div class="col-md-4">
                                            <label>Event End Date</label>
                                            <input type="text"
                                                value="{{ isset($event) ? \Carbon\Carbon::parse($event->event_end_date)->format('m/d/Y') : '' }}"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div
                                            class="form-group position-relative  gimmzi-will-use d-flex select-catagory1-main">
                                            <input type="checkbox" class="gimigi-checkbok ifcheck"
                                                style="top:24px; height: 15px; pointer-events: none;" value="1"
                                ...
                                <div class="col-md-12 field_col_d">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label>Address of Event</label>
                                            <input type="text" value="{{ $event->event_street_address ?? '' }}"
                                                disabled>
                                        </div>
                                        <div class="col-md-3">
                                            <label>City</label>
                    ...
                    <div class="login_popup_body">
                        <form id="changepassword">
                            <div class="form_grp merchent-input">
                                <input style="color:black;" type="password" placeholder="New Password"
                                    id="new_password" name="new_password" />
                                <span class="newerror"></span>
                            </div>
                            <div class="form_grp merchent-input">
                                <input style="color:black;" type="password" placeholder="Confirm Password"
    ...
    <div class="modal fade preview-modal" id="previewModal" tabindex="-1" aria-labelledby="previewModalLabel"
        ...
        <div class="modal-dialog modal-xl deal-management-modal">
            <div class="modal-content">
                <div class="modal-body position-relative">
                    <button type="button" class="close-button-one11 close_btn" data-bs-dismiss="modal"
                        id="">
                    ...
                    <div class="preview-deal-modal-main">
                        ...
                        <div class="bottom-location-main">
                            ...
                            @if (Auth::user()->merchantBusiness->business_phone != '')
                                <p style="color: black;"><img
                                        src="{{ asset('frontend_assets/images/call-16.svg') }}" alt="img" />
                                    Phone:
    ...
    <div class="modal fade cmn_modal_designs" id="edit_participating_location_modal" aria-hidden="true"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade merchent-main-madal" id="clickEndDateModal" tabindex="-1"
        aria-labelledby="clickEndDateModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body position-relative">
                    <div class="cross-icon11"><img data-bs-dismiss="modal" aria-label="Close"
                ...
                <div class="modal-body position-relative">
                    ...
                    <form id="dateSet" name="dateSet" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="merchent-input">
                                <input type="text" placeholder="" id="schedule_end_date" name="schedule_end_date"
                                    class="datepicker" style="margin:10px; padding:10px;" />
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-body position-relative">
                    <div class="cross-icon11"><img data-bs-dismiss="modal" aria-label="Close"
                            src="{{ asset('frontend_assets/images/cross-icon-one.svg') }}" /></div>
                    <div class="border_bottom">
                        <h3 style="color:#fff;">To allow participating consumers enough notice, the earliest the deal
                            can be ended is 14 days from time of request</h3>
                    </div>
                    <form id="dateSet" name="dateSet" method="post">
                        @csrf
                        <div class="row">
                            <p style="font-size: 23px;color: #fff;margin-top: 22px;">Deal End Date: <span
                                    id="setenddate"></span></p>
                ...
                <div class="modal-body position-relative">
                    ...
                    <form id="dateSet" name="dateSet" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="merchent-input">
                                <input type="text" placeholder="" id="extend_end_date" name="extend_end_date"
                                    class="datepicker" style="margin:10px; padding:10px;" />
                            </div>
                            <span id="scheduleenddaterror"></span>
                            ...
                            <div class="col-sm-6 login-top-one1">
                                <button class="login-button-one" type="button" name="stepone"
                                    id="extendDealEndDate" style="width:81%;">Extend</button>
                            </div>
                        </div>
    ...
    <div class="modal fade cmn_modal_designs gap_sec_modal2" id="location_success_modal" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(".collapsebutton").on('click', function() {
                    if ($('#itemserviceform').css('display') == 'none') {
                        ...
                        $("#collapseimage").attr('src',
                            "{{ asset('frontend_assets/images/left_arrow.png') }}");
                    } else {
                        $('#itemserviceform').hide();
                        $("#collapsetitle").text('');
                        $("#collapsetitle").text('Add an item or service to database');
                        $("#collapseimage").attr('src',
                            "{{ asset('frontend_assets/images/right_arrow.png') }}");
                    }
                })
            ...
            $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            if (result.status == 10) {
                                ...
                                $("#locationsuccessmsg").html(
                                    'Participating Location has been added successfully.');
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            if (result.status == 10) {
                                ...
                                $("#location_success_modal").modal('show');
                                $("#locationsuccessmsg").html(
                                    'Participating Location has been updated successfully.');
                                ...
                                $('#edit_cityerror').html('');
                                $('#edit_stateerror').html('');
                                $('#edit_phoneerror').html(result.validation_errors).css('color',
                                    'red');
                                ...
                                $('#edit_cityerror').html('');
                                $('#edit_stateerror').html('');
                                $('#edit_emailerror').html(result.validation_errors).css('color',
                                    'red');
                            } else if (result.status == 1) {
                                $('#edit_managers_error').html('');
                                $('#edit_locationnameerror').html('');
                                ...
                                $('#edit_cityerror').html('');
                                $('#edit_stateerror').html('');
                                $('#edit_faxerror').html(result.validation_errors).css('color',
                                    'red');
                            } else if (result.status == 6) {
                                $('#edit_managers_error').html('');
                                $('#edit_locationnameerror').html('');
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success == 1) {
                                ...
                                if (response.data.is_split != 0) {
                                    ...
                                    if (response.data.deal_location.length > 0) {
                                        if (voucher != 'Unlimited') {
                                            ...
                                            var divide = parseInt(voucher / response.data
                                                .deal_location.length);
                                        } else {
                                            var divide = voucher;
                                        }
                                ...
                                if (response.data.physical_location === response.data.deal_location
                                    .length) {
                                ...
                                if (response.locations.length > 0) {
                                    for (var i = 0; i < response.locations.length; i++) {
                                        ...
                                        if (response.data.deal_location.length > 0) {
                                            for (var j = 0; j < response.data.deal_location
                                                .length; j++) {
                                                if (response.data.deal_location[j].location_id ==
                                                    response.locations[i].id) {
                                                    location = 'yes';
                                                    checked = 'checked';
                                                    var checked_location = 'checked_location';
                                                    deal_location_count = parseInt(
                                                        deal_location_count + 1);
                                                    break;
                                                } else {
                                                    location = 'no';
                                                    checked = '';
                                            ...
                                            if (location === 'yes') {
                                                if (response.data.is_split != 0) {
                                                    if (response.data.voucher_unlimited == 0) {
                                                        //console.log(voucher);
                                                        var splitvoucher = parseInt(voucher /
                                                            response.data.deal_location.length);
                                                    } else {
                                                    ...
                                                    if (response.data.voucher_unlimited == 0) {
                                                        //console.log(voucher);
                                                        var splitvoucher = response.data
                                                            .voucher_number;
                                                    } else {
                                        ...
                                        if (response.locations[i].states) {
                                            var locationData = '<tr>' +
                                                '<td><b>' + response.locations[i].location_name +
                                                '</b><br>' +
                                                response.locations[i].address + ', ' + response
                                                .locations[i].city + ', ' +
                                                response.locations[i].states.name + ', ' + response
                                                ...
                                                checked + ' data-id = "' + response.locations[i]
                                                .id + '"/>' +
                                                '</div>' +
                                                '</td>' +
                                                '<td class="dealvoucher">' +
                                                '<div class="text-center assign-one4 assignedVoucher ' +
                                                checked_location + '" data-id = "' + response
                                                .locations[i].id + '">' + splitvoucher + '</div>' +
                                                '</td>' +
                                            ...
                                            var locationData = '<tr>' +
                                                ...
                                                response.locations[i].address + ', ' + response
                                                .locations[i].city + ', ' +
                                                response.locations[i].state_name + ', ' + response
                                                .locations[i].zip_code + ' ' +
                                                '<div class="" id="preview-deal-text">' +
                                                '<a href="javascript:void(0)" data-id = "' +
                                                response.locations[i].id +
                                ...
                                var s_Date = ((start_date.getMonth() > 8) ? (start_date.getMonth() +
                                        1) : ('0' + (start_date.getMonth() + 1))) + '/' + ((
                                        start_date.getDate() > 9) ? start_date.getDate() : (
                                        '0' + start_date.getDate())) + '/' + start_date
                                    .getFullYear();
                                if (response.data.end_Date != null) {
                                    var end_date = new Date(response.data.end_Date);
                                    var e_Date = ((end_date.getMonth() > 8) ? (end_date.getMonth() +
                                            1) : ('0' + (end_date.getMonth() + 1))) + '/' + ((
                                            end_date.getDate() > 9) ? end_date.getDate() : (
                                            '0' + end_date.getDate())) + '/' + end_date
                                        .getFullYear();
                                } else {
                                    var e_Date = 'Open';
                                }
                                ...
                                if (response.data.discount_type == 'free') {
                                    ...
                                    $("#discount_price").val(Math.floor(response.data
                                        .discount_amount) + '%');
                                }
                                $("#description").val('');
                                ...
                                if (response.locations.length > 0) {
                                    for (var i = 0; i < response.locations.length; i++) {
                                        ...
                                        if (response.data.loyaltylocations.length > 0) {
                                            for (var j = 0; j < response.data.loyaltylocations
                                                .length; j++) {
                                                if (response.data.loyaltylocations[j].location_id ==
                                                    response.locations[i].id) {
                                                    rewardlocation = 'yes';
                                                    rewardchecked = 'checked';
                                                    reward_checked_location = 'checked_location';
                                                    reward_location_count = parseInt(
                                                        reward_location_count + 1);
                                                    break;
                                                } else {
                                                    rewardlocation = 'no';
                                                    rewardchecked = '';
                                        ...
                                        if (response.locations[i].states) {
                                            var locationData = '<tr>' +
                                                ...
                                                rewardchecked + ' data-id = "' + response.locations[
                                                    i].id + '"/>' +
                                                '</div>' +
                                                '</td>' +
                                                '<td class="totalmember">' +
                                                '<div class="text-center assign-one4" data-id = "' +
                                                response.locations[i].id + '"></div>' +
                                                '</td>' +
                                                '<td><div class="text-center assign-one4">0%</div></td>' +
                                                '</tr>';
                                        } else {
                ...
                $(document).on('click', '.split_voucher', function() {
                    ...
                    if ($('.deal_voucher').text().trim() != 'Unlimited') {
                        if ($('.split_voucher').is(':checked') == true) {
                            ...
                            var deal_id = $(".select_deal").val();
                            $('.dealvoucher').find('div').html('');
                            $('.dealvoucher').find('div.checked_location').html($('.deal_voucher').text()
                                .trim());
                        }
                        $.ajax({
                            ...
                            if (response.status == 1) {
                                if (response.data.location_manager_count > 0) {
                                    if (response.data.location_manager_count == 1) {
                                        $("#edit_manager_count").html(response.data
                                            .location_manager_count +
                                            ' manager assigned to this location');
                                    } else {
                                        $("#edit_manager_count").html(response.data
                                            .location_manager_count +
                                            ' managers assigned to this location');
                                    }
                                } else {
                                ...
                                if (response.data.location_associate_count > 0) {
                                    if (response.data.location_associate_count == 1) {
                                        $("#edit_associate_count").html(response.data
                                            .location_associate_count +
                                            ' additional user assigned to this location');
                                    } else {
                                        $("#edit_associate_count").html(response.data
                                            .location_associate_count +
                                            ' additional users assigned to this location');
                                    }

                                } else {
                                    $('#edit_location_associate').prop('disabled', 'disabled');
                                    $("#edit_associate_count").html(
                                        'No additional users assigned to this location');
                                }
                                ...
                                $(".locationname").html('Location: ' + response.data.address +
                                    ', ' + response.data.city + ', ' + response.data.zip_code);
                                ...
                                if (response.data.location_manager.length > 0) {
                                    ...
                                    for (var i = 0; i < response.data.location_manager
                                        .length; i++) {
                                        ...
                                        var managerdata = '<tr><td></td>' +
                                            '<td>' + response.data.location_manager[i].merchant_user
                                            .full_name +
                                            '</td>' +
                                            '<td>' + response.data.location_manager[i].merchant_user
                                            .title.title_name +
                                            '</td>' +
                                            '<td><a href="javascript:void(0);" class="remove_access" data-id = "' +
                                            response.data.location_manager[i].merchant_user.id +
                                            '">Remove Access</a>' +
                                            '</td>' +
                                            '<td><input type="checkbox" class="assign-one1" ' +
                                            checked + '></td>' +
                                            '</tr>';
                                ...
                                if (response.data.location_associate.length > 0) {
                                    ...
                                    $("#edit_location_associate").val(firstAssociate.merchant_user
                                        .id);

                                    for (var j = 0; j < response.data.location_associate
                                        .length; j++) {
                                        ...
                                        var associatedata = '<tr><td></td>' +
                                            '<td>' + response.data.location_associate[j]
                                            .merchant_user.full_name +
                                            '</td>' +
                                            '<td>' + response.data.location_associate[j]
                                            .merchant_user.title.title_name +
                                            '</td>' +
                                            '<td><a href="javascript:void(0);" class="remove_access" data-id = "' +
                                            response.data.location_associate[j].merchant_user.id +
                                            '">Remove Access</a>' +
                                            '</td>' +
                                            '<td><input type="checkbox" class="assign-one1" ' +
                                            checked + '></td>' +
                                ...
                                if (response.users.length > 0) {
                                    ...
                                    for (var x = 0; x < response.users.length; x++) {
                                        ...
                                        var add_user_data = '<option value="' + response.users[x]
                                            .id + '">' + response.users[x].full_name + ' - ' +
                                            response.users[x].title.title_name + '</option>';
                            ...
                            success: function(response) {
                                ...
                                if (response.status == 1) {
                                    ...
                                    if (response.data.location_manager_count > 0) {
                                        ...
                                        $("#edit_location_manager").val(firstManager.merchant_user
                                            .id);
                                        if (response.data.location_manager_count == 1) {
                                            $("#edit_manager_count").html(response.data
                                                .location_manager_count +
                                    ...
                                    if (response.data.location_associate_count > 0) {
                                        ...
                                        $("#edit_location_associate").val(firstAssociate
                                            .merchant_user.id);
                                    }
                            ...
                            if (response.status == 1) {
                                if (response.all_location == 1) {
                                    ...
                                    if (checked == 'yes') {
                                        ...
                                        myVar.parent().parent().next('.dealvoucher').find(
                                            "div.assignedVoucher").addClass('checked_location');
                                        if ($('.split_voucher').is(':checked')) {
                                            if ($('.deal_voucher').text().trim() != 'Unlimited') {
                                                var voucher = $('.deal_voucher').text().trim();
                                                var checkedLocation = $('.checked_location').length;
                                                var splited_voucher = parseInt(voucher /
                                                    checkedLocation);
                                        ...
                                        myVar.parent().parent().next('.dealvoucher').find(
                                            "div.assignedVoucher").removeClass(
                                            'checked_location');
                                        myVar.parent().parent().next('.dealvoucher').find(
                                            "div.assignedVoucher").text('');
                                        if ($('.split_voucher').is(':checked')) {
                                            if ($('.deal_voucher').text().trim() != 'Unlimited') {
                                                var voucher = $('.deal_voucher').text().trim();
                                                var checkedLocation = $('.checked_location').length;
                        ...
                        success: function(response) {
                            ...
                            if (response.success == 0) {
                                ...
                                $("#deallocation").find('tr').each(function() {
                                    if ($(this).children("td").next("td").find(
                                            'input.locationAssigned').not(':checked')) {
                                        $(this).children("td").next("td").find(
                                            'input.locationAssigned').prop('checked',
                                            true);
                                        $(this).children("td").next("td").next(
                                            "td.dealvoucher").find(
                                            "div.assignedVoucher").addClass(
                                            'checked_location');
                                        if ($('.split_voucher').is(':checked')) {
                                            if ($('.deal_voucher').text().trim() !=
                                                'Unlimited') {
                                                var voucher = $('.deal_voucher').text()
                                                    .trim();
                                                var checkedLocation = $('.checked_location')
                                                    .length;
                                                var splited_voucher = parseInt(voucher /
                                                    checkedLocation);
                                                //console.log(splited_voucher);
                        ...
                        success: function(response) {
                            ...
                            if (response.success == 0) {
                                ...
                                $("#loyaltylocation").find('tr').each(function() {
                                    if ($(this).children("td").next("td").find(
                                            'input.rewardlocationAssigned').not(
                                            ':checked')) {
                                        $(this).children("td").next("td").find(
                                            'input.rewardlocationAssigned').prop(
                                            'checked', true);
                                    }
                            ...
                            if (response.success == 1) {
                                ...
                                if (response.data.length > 0) {
                                    ...
                                    for (var x = 0; x < response.data.length; x++) {
                                        ...
                                        $('#deal_name').html(response.data[x].deal
                ...
                $(document).on('click', '.deal_schedule_end_date', function() {
                    ...
                    var setdate = ("0" + (today.getMonth() + 1)).slice(-2) + '/' + today.getDate() + '/' + today
                        .getFullYear();
                    $("#schedule_end_date").datepicker("option", {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status == 0) {
                                $("#scheduleenddaterror").html(response.validation_errors).css(
                                    'color', 'red');
                            } else if (response.status == 1) {
                ...
                $(document).on('click', '.extend_deal', function() {
                    ...
                    var setdate = ("0" + (end_date.getMonth() + 1)).slice(-2) + '/' + end_date.getDate() + '/' +
                        end_date.getFullYear();
                    // $("#extend_end_date").val(setdate);
                    $("#extend_end_date").datepicker("option", {
                        "minDate": new Date(setdate)
                    });
