            ...
            <div class="first-goback-search-sec">
                <div class="container mx-4 d-flex align-items-center">
                    ...
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('frontend.explore') }}">Explore</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('frontend.market-universe') }}">Gimmzi Market
                                    Universe</a></li>
                                    ...
                                    <div class="">
                                        <div class="card p-1 p-md-4">
                                            ...
                                            @foreach (collect($data['deals'])->take(3) as $deal)
                                                @if ($deal->dealLocation->contains('location_id', $getBusinessLocation->id))
                                                    <div class="form-check mt-3" data-bs-toggle="modal"
                                                        ...
                                                        <input class="form-check-input2" type="radio"
                                                            name="offer" id="offer1" value="25-off-all-products"
            ...
            @if ($allLocations)
                <div class="container mt-5">
                    ...
                    <div id="locationCarousel" class="carousel slide" data-bs-ride="carousel">
                        ...
                        @else
                            @php
                                $allBusinessWIthSameCategory = \App\Models\BusinessProfile::where(
                                    ...
                                    ->with(['locations'])
                                    ->get();
                                // dd($allBusinessWIthSameCategory);
                                $otherCategoryLocations = collect();

                                foreach ($allBusinessWIthSameCategory as $biz) {
                                    foreach ($biz->locations as $loc) {
                                        $otherCategoryLocations->push(['business' => $biz, 'location' => $loc]);
                                    }
                                }

                                $chunks = $otherCategoryLocations->chunk(4);
                            @endphp
