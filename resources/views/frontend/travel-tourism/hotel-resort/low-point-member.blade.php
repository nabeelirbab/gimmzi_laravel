<x-layouts.travel-tourism-layout title="Travel-Tourism">
    @push('style')
    <style>
        .errorMsq {
            color: red !important;
    ...
    @endpush
    <livewire:frontend.travel-tourism.hotel-resort.low-point-member>
    ...
    <script src="https://cdn.jsdelivr.net/jquery.validation/1.16.0/additional-methods.min.js"></script>
        <script>
            ...
            $(document).on('click','.add_term',function(){
                ...
                var value1 = $('#property_id').val();
                var text = 'add_term';
                let ajaxPath = base_url + "/low-point-member" + "?id=" + value1 +
                    "&unit=" + unitid + "&text=" + text + "&checked=" + checked;
                $.ajax({
                    type: 'GET',
                    url: ajaxPath,
    ...
    @endpush
</x-layouts.travel-tourism-layout>