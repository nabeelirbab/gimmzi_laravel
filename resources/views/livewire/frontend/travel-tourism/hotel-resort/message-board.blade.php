<div>
  ...
  @endpush
    <div class="all-smart-rental-database-main-sec">
        ...
        <div>
          <form method="post" wire:submit.prevent="addHotelMessageBoard">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4 top-space18">
                        {{-- @if($add_date1 == true)
                          ...
                          @else
                          <input type="date" id="open_start_date" wire:model.defer="start_date" disabled/>
                        @endif
                      @error('start_date')
                          <span class="invalid-message" role="alert"
                              style="font-size: 12px; color:red;">
                      ...
                      <div class="col-sm-4 top-space18">
                        {{-- @if($add_date1 == true)
                          ...
                          @else
                          <input type="date" id="open_end_date" wire:model.defer="end_date" disabled/>
                        @endif
                          ...
                          {{-- <input type="checkbox" wire:model.defer="add_message_date" class="assign-one1 check_no_checkbox" style="width: 25px!important;height: 25px!important;margin-top: 7px;" id="dateCheck" wire:click="addtoDate1">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="mb-3" wire:ignore>
                            ...
                            <textarea style="margin-top: 51px;"  wire:model.defer="message" id="message" rows="3"
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4 top-space18">
                        {{-- @if($add_date2 === true )
                          ...
                          @else
                          <input type="date" id="open_start_date2" wire:model.defer="start_date2" disabled/>
                        @endif
                          @error('start_date2')
                              <span class="invalid-message" role="alert"
                                  style="font-size: 12px; color:red;">
                      ...
                      <div class="col-sm-4 top-space18">
                        {{-- @if($add_date2 == true)
                          ...
                          @else
                          <input type="date"  id="open_end_date2" wire:model.defer="end_date2" disabled />
                          @endif
                          @error('end_date2')
                              <span class="invalid-message" role="alert"
                                  style="font-size: 12px; color:red;">
                              ...
                              <br>
                          @enderror
                          <input type="checkbox" wire:model.defer="add_message_date2" class="assign-one1 check_no_checkbox" style="width: 25px!important;height: 25px!important;margin-top: 7px;" id="dateCheck" wire:click='addtoDate2'>
                          <label for="dateCheck" style="position: absolute;margin-left: 7px;color:black;margin-top: 7px;">Add dates to message</label> --}}
                        <br>
                        {{-- @error('add_message_date2')
                        <span class="invalid-message" role="alert"
                            style="font-size: 12px; color:red;">
                            {{ $message }}
                        </span>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="mb-3" wire:ignore>
                            ...
                            <textarea style="margin-top: 51px;" wire:model.defer="message2" id="message2" rows="3"
                            placeholder="Enter the message"></textarea>
          ...
          <script>
            ...
            document.addEventListener('livewire:load', function (event) {
              ...
              // @this.on('enableMessageDate', data =>{
              //   $("#open_end_date").prop('disabled', false);
              //   $("#open_start_date").prop('disabled', false);
              // })
            ...
            // $(document).on('click', '.check_no_checkbox1', function(){
            //   $("#open_end_date").prop('disabled', false);
            //   $("#open_start_date").prop('disabled', false);
            // })
            // $(document).on('click', '.check_no_checkbox2', function(){
            //   $("#open_end_date2").prop('disabled', false);
            //   $("#open_start_date2").prop('disabled', false);
            // })
