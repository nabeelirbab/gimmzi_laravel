<x-admin.table>
    ...
    <x-slot name="thead">
        <tr role="row">
            ...
            <th class="align-center" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 15%;"
                aria-sort="ascending" aria-label="Agent: activate to sort column descending">UserID <i
                    class="fa fa-fw fa-sort pull-right" style="cursor: pointer;" wire:click="sortBy('userId')"></i>
            </th>
        ...
        <tr class="filter">
            ...
            <th>
                <x-admin.input type="search" wire:model.defer="searchUserId" placeholder="" autocomplete="off"
                    class="form-control-sm form-filter" />
            </th>
            <th>
    ...
    <x-slot name="tbody">
        ...
        <td class="sorting_1 align-center" tabindex="0">
                ...
                <x-admin.td-action>
                    <a class="dropdown-item" href="{{ route('provider-user.edit', ['provider_user' => $user->id]) }}"><i
                            class="la la-edit"></i> Edit</a>
                    <a class="dropdown-item" href="{{ route('admin.provider.id-verification', ['id' => $user->id]) }}"><i
        ...
        <x-admin.td-action>
            <a class="dropdown-item" href="{{route('provider-user.edit', ['user' => $user->id])}}"><i class="la la-edit"></i>
                Edit</a>
            <button href="#" class="dropdown-item" wire:click="deleteAttempt({{ $user->id }})"><i
                    class="fa fa-trash"></i> Delete</button>
        </x-admin.td-action>
