<x-admin.form-section submit="saveOrUpdate">
    <x-slot name="form"> 
        <x-admin.form-group>
            ...
            <x-admin.dropdown wire:model.defer="provider_id" placeHolderText="Please select one" autocomplete="off" id="provider"
        ...
        <x-admin.form-group>
            ...
            <x-admin.input type="text" wire:model.defer="unit" placeholder="Unit"
    ...
    <x-slot name="actions">
        ...
        <x-admin.link :href="route('provider-unit.index')" color="secondary">Cancel</x-admin.link>
    </x-slot>
    </x-form-section>
    @push('scripts')
    <script>
