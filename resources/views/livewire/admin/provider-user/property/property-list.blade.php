<x-admin.table>
    ...
    <x-slot name="thead">
        <tr role="row">
            <th tabindex="0" class="align-center" aria-controls="kt_table_1" rowspan="1" colspan="1"
                style="width: 23%;" aria-label="Company Email: activate to sort column ascending">Property
            </th>
            <th tabindex="0" class="align-center" aria-controls="kt_table_1" rowspan="1" colspan="1"
                style="width: 23%;" aria-label="Company Email: activate to sort column ascending">Title
            </th>
            <th tabindex="0" class="align-center" aria-controls="kt_table_1" rowspan="1" colspan="1"
    ...
    Showing {{ $properties->firstitem() ?? 0 }} to {{ $properties->lastitem() ?? 0 }} of {{ $properties->total() }}
        entries
    </x-slot>
</x-admin.table>
